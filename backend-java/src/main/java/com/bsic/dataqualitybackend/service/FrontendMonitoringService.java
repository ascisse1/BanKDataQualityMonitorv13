...
public class FrontendMonitoringService {
    ...
    public FrontendMonitoringService(MeterRegistry meterRegistry) {
        ...
        // Initialize counters
        this.frontendLogCounter = Counter.builder("bsic_frontend_logs_total")
                .description("Total frontend logs received")
                .tag("application", "bsic-data-quality")
                .register(meterRegistry);

        this.frontendErrorCounter = Counter.builder("bsic_frontend_errors_total")
                .description("Total frontend errors received")
                .tag("application", "bsic-data-quality")
                .register(meterRegistry);

        this.frontendWarningCounter = Counter.builder("bsic_frontend_warnings_total")
                .description("Total frontend warnings received")
                .tag("application", "bsic-data-quality")
                .register(meterRegistry);

        this.frontendApiErrorCounter = Counter.builder("bsic_frontend_api_errors_total")
                .description("Total frontend API errors")
                .tag("application", "bsic-data-quality")
                .register(meterRegistry);

        this.frontendPageViewCounter = Counter.builder("bsic_frontend_pageviews_total")
    ...
    private void handleError(FrontendLogDto.LogEntry entry, String sessionId, String environment) {
        ...
        Counter.builder("bsic_frontend_errors_by_category")
