...
-- Clear existing data
TRUNCATE TABLE bkemacli;
TRUNCATE TABLE bkcntcli;
TRUNCATE TABLE bkprfcli;
TRUNCATE TABLE bkadcli;
TRUNCATE TABLE bkcom;
TRUNCATE TABLE bkcli;
...
('CLI000000000007', 'KONE', '1', 'Mlle', 'Aminata', 'F', '1995-12-03', 'San Pedro', 'CIV', 'CIV', 'CIV', 'C', 0, 'CI0195121234567', '00100', '001', 'O', 'FRA', 'N', 'N', 'ADMIN', '2022-08-19', '2024-08-19'),
...
('CLI000000000014', 'MEITE', '1', 'Mlle', 'Rokia', 'F', '1998-03-18', 'Seguela', 'CIV', 'CIV', 'CIV', 'C', 0, 'CI0198031597534', '00300', '003', 'O', 'FRA', 'N', 'N', 'ADMIN', '2023-01-25', '2024-01-25'),
...
('CLI000000000020', 'DEMBELE', '1', 'Mlle', 'Fanta', 'F', '1997-01-14', 'Tengrela', 'CIV', 'CIV', 'CIV', 'C', 0, 'CI0197017896321', '00300', '003', 'O', 'FRA', 'N', 'N', 'ADMIN', '2023-06-12', '2024-06-12');
...
('CLI000000000022', 'SOCIETE AFRICAINE DE CONSTRUCTION', '2', 'SOCIETE AFRICAINE DE CONSTRUCTION SA', 'SAC', '2005-07-15', 'SA', 'CI-ABJ-2005-B-03215', '2025-07-15', 'NIF2005032150', 'PT2005032150', '2025-07-15', 'BTP01', '00100', '001', 'O', 'FRA', 'N', 'N', 'ADMIN', '2012-08-22', '2024-05-15'),
('CLI000000000023', 'TRANSPORT EXPRESS IVOIRE', '2', 'TRANSPORT EXPRESS IVOIRE SARL', 'TEI', '2015-11-08', 'SR', 'CI-ABJ-2015-B-08742', '2025-11-08', 'NIF2015087420', 'PT2015087420', '2025-11-08', 'TRS01', '00200', '002', 'O', 'FRA', 'N', 'N', 'ADMIN', '2016-02-28', '2024-06-20'),
('CLI000000000024', 'AGRO BUSINESS COTE D IVOIRE', '2', 'AGRO BUSINESS COTE D IVOIRE SA', 'ABCI', '2008-04-25', 'SA', 'CI-ABJ-2008-B-06123', '2025-04-25', 'NIF2008061230', 'PT2008061230', '2025-04-25', 'AGR01', '00300', '003', 'O', 'FRA', 'N', 'N', 'ADMIN', '2013-06-14', '2024-03-08'),
...
('CLI000000000026', 'HOTEL PALM BEACH ABIDJAN', '2', 'HOTEL PALM BEACH ABIDJAN SA', 'HPBA', '2012-06-30', 'SA', 'CI-ABJ-2012-B-09854', '2025-06-30', 'NIF2012098540', 'PT2012098540', '2025-06-30', 'HTL01', '00400', '004', 'O', 'FRA', 'N', 'N', 'ADMIN', '2014-09-18', '2024-04-30'),
...
('CLI000000000028', 'CABINET JURIDIQUE AFRIQUE', '2', 'CABINET JURIDIQUE AFRIQUE SAS', 'CJA', '2014-10-05', 'SS', 'CI-ABJ-2014-B-11568', '2025-10-05', 'NIF2014115680', 'PT2014115680', '2025-10-05', 'SRV01', '00100', '001', 'O', 'FRA', 'N', 'N', 'ADMIN', '2015-12-10', '2024-02-18'),
...
-- ============================================================================
-- BKCOM - Comptes (30 accounts for 30 clients)
-- ============================================================================
...
('00200000023', '00', '00200', 'XOF', '371100000', '56', 'CLI000000000023', 'TRANSPORT EXPRESS IVOIRE', 'CCE', 23654780.0000, 23654780.0000, '2016-02-28', '2024-11-30', '2024-11-30', 'N', 'N', 'ADMIN'),
...
('00100000028', '00', '00100', 'XOF', '371100000', '61', 'CLI000000000028', 'CABINET JURIDIQUE AFRIQUE', 'CCE', 8965470.0000, 8965470.0000, '2015-12-10', '2024-12-01', '2024-12-01', 'N', 'N', 'ADMIN'),
...
-- Adresses particuliers (Domicile)
...
('CLI000000000006', 'DIR', 'AUTO-EMPLOYE', '2005-07-01', '08', 'Daloa'),
('CLI000000000007', 'STG', 'SODECI', '2023-01-15', '02', 'Abidjan'),
('CLI000000000008', 'ENS', 'MENET-FP', '2014-10-01', '04', 'Ferkessedougou'),
('CLI000000000009', 'MED', 'CHU COCODY', '2016-06-15', '06', 'Abidjan'),
('CLI000000000010', 'AGR', 'INDEPENDANT', '2000-03-01', '05', 'Odienne'),
('CLI000000000011', 'INF', 'MTN CI', '2021-02-01', '04', 'Abidjan'),
('CLI000000000012', 'COM', 'PROSUMA', '2017-11-20', '03', 'Abidjan'),
('CLI000000000013', 'RET', NULL, '1975-06-01', '02', NULL),
('CLI000000000014', 'ETU', NULL, NULL, '01', NULL),
('CLI000000000015', 'AVT', 'BICICI', '2011-08-10', '05', 'Abidjan'),
('CLI000000000016', 'COM', 'INDEPENDANT', '2008-04-15', '04', 'Aboisso'),
('CLI000000000017', 'TEC', 'PETRO IVOIRE', '2020-07-01', '03', 'Duekoue'),
('CLI000000000018', 'SEC', 'CFAO MOTORS', '2019-05-20', '03', 'Abidjan'),
('CLI000000000019', 'AGR', 'INDEPENDANT', '2005-01-01', '04', 'Bondoukou'),
('CLI000000000020', 'ETU', NULL, NULL, '01', NULL);

-- ============================================================================
-- BKCNTCLI - Contacts Clients
-- ============================================================================

INSERT INTO bkcntcli (cli, nom, pre, tel, email) VALUES
('CLI000000000001', 'KOUASSI', 'Ange Michel', '+225 0708123456', 'ange.kouassi@email.ci'),
('CLI000000000002', 'KONAN', 'Adjoua Marie', '+225 0507234567', 'marie.konan@email.ci'),
('CLI000000000003', 'TRAORE', 'Ibrahim', '+225 0102345678', 'ibrahim.traore@email.ci'),
('CLI000000000004', 'DIALLO', 'Fatou', '+225 0503456789', 'fatou.diallo@email.ci'),
('CLI000000000005', 'YAO', 'Kouadio Jean', '+225 0704567890', 'jean.yao@email.ci'),
('CLI000000000006', 'BAMBA', 'Seydou', '+225 0105678901', 'seydou.bamba@email.ci'),
('CLI000000000007', 'KONE', 'Aminata', '+225 0506789012', 'aminata.kone@email.ci'),
('CLI000000000008', 'OUATTARA', 'Mamadou', '+225 0707890123', 'mamadou.ouattara@email.ci'),
('CLI000000000009', 'TOURE', 'Awa', '+225 0108901234', 'awa.toure@email.ci'),
('CLI000000000010', 'COULIBALY', 'Drissa', '+225 0509012345', 'drissa.coulibaly@email.ci'),
('CLI000000000011', 'GNAGNE', 'Pascal', '+225 0710123456', 'pascal.gnagne@email.ci'),
('CLI000000000012', 'SORO', 'Mariam', '+225 0511234567', 'mariam.soro@email.ci'),
('CLI000000000013', 'ACHI', 'Christophe', '+225 0112345678', 'christophe.achi@email.ci'),
('CLI000000000014', 'MEITE', 'Rokia', '+225 0713456789', 'rokia.meite@email.ci'),
('CLI000000000015', 'TANOH', 'Yves', '+225 0514567890', 'yves.tanoh@email.ci'),
('CLI000000000016', 'ZADI', 'Henriette', '+225 0115678901', 'henriette.zadi@email.ci'),
('CLI000000000017', 'GUEHI', 'Simplice', '+225 0716789012', 'simplice.guehi@email.ci'),
('CLI000000000018', 'LAGO', 'Josephine', '+225 0517890123', 'josephine.lago@email.ci'),
('CLI000000000019', 'KASSI', 'Emmanuel', '+225 0118901234', 'emmanuel.kassi@email.ci'),
('CLI000000000020', 'DEMBELE', 'Fanta', '+225 0719012345', 'fanta.dembele@email.ci'),

-- Contacts entreprises (Responsables)
('CLI000000000021', 'KOUAME', 'Georges', '+225 2720300101', 'g.kouame@gin.ci'),
('CLI000000000022', 'KOFFI', 'Bernard', '+225 2720200202', 'b.koffi@sac-ci.com'),
('CLI000000000023', 'ASSI', 'Patrick', '+225 2721300303', 'p.assi@tei.ci'),
('CLI000000000024', 'BROU', 'Sylvain', '+225 2722400404', 's.brou@abci.ci'),
('CLI000000000025', 'TAPE', 'Augustin', '+225 2720500505', 'a.tape@pdp.ci'),
('CLI000000000026', 'N GUESSAN', 'Marcel', '+225 2721600606', 'm.nguessan@hpba.ci'),
('CLI000000000027', 'DIABATE', 'Souleymane', '+225 2722700707', 's.diabate@importex.ci'),
('CLI000000000028', 'KOBENAN', 'Isabelle', '+225 2720800808', 'i.kobenan@cja.ci'),
('CLI000000000029', 'OULAÏ', 'Franck', '+225 2721900909', 'f.oulai@esci.ci'),
('CLI000000000030', 'GBANE', 'Lacina', '+225 2722001010', 'l.gbane@maquis.ci');

-- ============================================================================
-- BKEMACLI - Emails Clients
-- ============================================================================

INSERT INTO bkemacli (cli, typ, email, atrf) VALUES
-- Emails personnels particuliers
('CLI000000000001', 'PER', 'ange.kouassi@gmail.com', 'N'),
('CLI000000000002', 'PER', 'marie.konan@yahoo.fr', 'N'),
('CLI000000000003', 'PER', 'ibrahim.traore@gmail.com', 'N'),
('CLI000000000004', 'PER', 'fatou.diallo@outlook.com', 'N'),
('CLI000000000005', 'PER', 'jean.yao@gmail.com', 'N'),
('CLI000000000006', 'PER', 'seydou.bamba@yahoo.fr', 'N'),
('CLI000000000007', 'PER', 'aminata.kone@gmail.com', 'N'),
('CLI000000000008', 'PER', 'mamadou.ouattara@outlook.com', 'N'),
('CLI000000000009', 'PER', 'awa.toure@gmail.com', 'N'),
('CLI000000000010', 'PER', 'drissa.coulibaly@yahoo.fr', 'N'),
...
('CLI000000000011', 'PRO', 'pgnagne@mtn.ci', 'N'),
('CLI000000000015', 'PRO', 'ytanoh@bicici.com', 'N'),
('CLI000000000017', 'PRO', 'sguehi@petroivoire.ci', 'N'),
('CLI000000000018', 'PRO', 'jlago@cfao.com', 'N'),

-- Emails entreprises
('CLI000000000021', 'PRO', 'contact@gin.ci', 'N'),
('CLI000000000022', 'PRO', 'contact@sac-ci.com', 'N'),
('CLI000000000023', 'PRO', 'info@tei.ci', 'N'),
('CLI000000000024', 'PRO', 'contact@abci.ci', 'N'),
('CLI000000000025', 'PRO', 'pharmacie.plateau@gmail.com', 'N'),
('CLI000000000026', 'PRO', 'reservation@hpba.ci', 'N'),
('CLI000000000027', 'PRO', 'info@importex.ci', 'N'),
('CLI000000000028', 'PRO', 'contact@cja.ci', 'N'),
('CLI000000000029', 'PRO', 'info@esci.ci', 'N'),
('CLI000000000030', 'PRO', 'maquis.reserve@gmail.com', 'N');
...
SELECT 'bkcli:', COUNT(*) FROM bkcli;
SELECT 'bkcom:', COUNT(*) FROM bkcom;
SELECT 'bkadcli:', COUNT(*) FROM bkadcli;
SELECT 'bkprfcli:', COUNT(*) FROM bkprfcli;
SELECT 'bkcntcli:', COUNT(*) FROM bkcntcli;
SELECT 'bkemacli:', COUNT(*) FROM bkemacli;
