...
import com.adakalgroup.dataqualitybackend.dto.BranchAnomalyDto;
import com.adakalgroup.dataqualitybackend.dto.DashboardStatsDto;
import com.adakalgroup.dataqualitybackend.dto.ValidationMetricDto;
...
public class StatsService {
    ...
    @org.springframework.cache.annotation.Cacheable(value = "statistics", key = "'anomalies-by-branch'")
    ...
    @org.springframework.cache.annotation.Cacheable(value = "statistics", key = "'validation-metrics'")
    ...
    private AnomalyDto mapToAnomalyDto(com.adakalgroup.dataqualitybackend.model.Anomaly anomaly) {
