...
public interface AnomalyRepository extends JpaRepository<Anomaly, Long> {
    ...
    @Query("SELECT COUNT(DISTINCT a.clientNumber) FROM Anomaly a " +
           ...
           "AND a.status NOT IN (com.adakalgroup.dataqualitybackend.model.enums.AnomalyStatus.CORRECTED, " +
           "com.adakalgroup.dataqualitybackend.model.enums.AnomalyStatus.VALIDATED, " +
           "com.adakalgroup.dataqualitybackend.model.enums.AnomalyStatus.CLOSED)")
    ...
    @Query("SELECT COUNT(a) > 0 FROM Anomaly a " +
           ...
           "AND a.status NOT IN (com.adakalgroup.dataqualitybackend.model.enums.AnomalyStatus.CLOSED, " +
           "com.adakalgroup.dataqualitybackend.model.enums.AnomalyStatus.VALIDATED)")
