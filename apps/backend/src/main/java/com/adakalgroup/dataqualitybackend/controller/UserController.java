...
import com.adakalgroup.dataqualitybackend.model.enums.UserRole;
import com.adakalgroup.dataqualitybackend.model.enums.UserStatus;
...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getUserStats() {
        ...
        long agenciesWithUsers = userProfileRepository.findAll().stream()
                .filter(up -> up.getStatus() == com.adakalgroup.dataqualitybackend.model.enums.UserProfileStatus.ACTIVE)
